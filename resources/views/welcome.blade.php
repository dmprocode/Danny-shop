@include('systeam-admin.admin-templete-controller.header')
@include('systeam-admin.admin-templete-controller.sidenave')
@include('systeam-admin.admin-templete-controller.topnav')
            ...
            <div class="card-body">
                <div class="dropdown float-end">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item">Export Report</a>
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-thanks Im glad eto here youitem">Profit</a>
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">Action</a>
                    </div>
                </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                ...
                <div class="progress-w-percent">
                    <span class="progress-value fw-bold">39k </span>thanks Im glad eto here you
                    ...
                    <table class="table table-centered table-nowrap table-hover mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                </td>thanks Im glad eto here you
                                <td>
...
<!-- container -->
@include('systeam-admin.admin-templete-controller.footer')
