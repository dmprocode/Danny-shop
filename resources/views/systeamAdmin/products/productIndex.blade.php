                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @if($product->image == "")
                                                <td>
                                                    <img src="{{ asset('assets/myImage/santa-claus-red-sleigh-and-green-gift-boxes-16911.png') }}"
                                                ...
                                                <td class="__web-inspector-hide-shortcut__">
                                                    <a href="javascript:void(0);"
                                                        class="action-icon __web-inspector-hide-shortcut__"> <i
                                                            class="mdi mdi-eye"></i></a>
                                                    <a href="javascript:void(0);" class="action-icon"> <i
                                                            class="mdi mdi-square-edit-outline edit-product-btn"
                                                            ...
                                                            data-number_pieces="{{$product->number_pieces}}"></i></a>
                                                    <a href="javascript:void(0);" class="action-icon"> <i
                                                            class="mdi mdi-delete delete-product-id"
                        ...
                        <div class="d-flex justify-content-end gap-3 my-3">
                            <div class="p-3 bg-gradient bg-info text-white rounded shadow-sm">
                                <h5 class="mb-0">
                                    ...
                                    <strong>Total Capital :</strong> {{number_format($adminComponents['totalValue'],2)}}
                                </h5>
                            </div>
