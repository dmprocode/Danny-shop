        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-5">
                            <a href="javascript:void(0);" class="btn btn-outline-info btn-sm  mb-2 make-purchases-btn"><i
                                    class="mdi mdi-plus-circle me-2 h4"></i> <span class="h5">Make Purchases </span> </a>
                        </div>
                        <div class="col-sm-7 ">
                        ...
                        <div class="row parchasses-table">
                            <div class="col-12">
                        ...
                        <form action="#" id="parchassesFrormData">
                            ...
                            <div class="row">
                              ...
                              <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-control select2 product-price" data-toggle="select2" id="select-product-price" name="product_name">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" id="parchasses-buying-price" class="form-control form-control-sm " name="buying_price"
                                        name="parchasses-buying-price">
                                    <i class="text-danger parchasses-buying-priceMSG message fw-normal role font-16"></i>

                                </div>

                                <div class="mb-3 col-md-6">
                                    <label for="simpleinput" class="form-label fw-normal fs-16 ">Number of Catton:</label>
                                    <input type="number" id="parchasses_number_of_catton" class="form-control form-control-sm "
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" id="size" class="form-control form-control-sm " name="salesPoint">
